...
@endsection
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('leave_types.leave_type.index') }}">{{(__('employee.Leave Type'))}}</a>
</li>
...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('leave_types.leave_type.store') }}" accept-charset="UTF-8"
            id="create_leave_type_form" name="create_leave_type_form" class="form-horizontal">
            {{ csrf_field() }}
