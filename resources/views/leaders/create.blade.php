                ...
                <div class="form-group col-md-3 {{ $errors->has('from') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-12">
                        <input class="form-control" name="from" type="text" id="from"
                            value="{{ Request::old('from') ?: '' }}" placeholder="ከ">
                        <span
                            class="{{ $errors->has('from') ? 'helper-text red-text' : '' }}">{{ $errors->first('from') }}</span>
                    </div>
                </div>
                <div class="form-group col-md-3 {{ $errors->has('to') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-12">
                        <input class="form-control" name="to" type="text" id="to"
                            value="{{ Request::old('to') ?: '' }}" placeholder="እስከ">
                        <span
                            class="{{ $errors->has('to') ? 'helper-text red-text' : '' }}">{{ $errors->first('to') }}</span>
                    </div>
                </div>
