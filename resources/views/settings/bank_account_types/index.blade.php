...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_BankAccountTypes-List')
                            ...
                            @foreach ($bankAccountTypes as $bankAccountType)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('setting_BankAccountTypes-Edit')
                                        ...
                                        @endpermission
                                        @permission('setting_BankAccountTypes-Delete')
    ...
    @permission('setting_BankAccountTypes-AddNew')
