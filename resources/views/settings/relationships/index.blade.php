...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_Relationships-List')
    ...
    @permission('setting_Relationships-AddNew')
