...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a
            href="{{ route('disaster_causes.disaster_cause.index') }}">{{ __('employee.Disaster Cause') }}</a></li>
...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_DisasterCause-Edit')
                <form method="POST" action="{{ route('disaster_causes.disaster_cause.update', $disasterCause->id) }}"
                    id="edit_disaster_cause_form" name="edit_disaster_cause_form" accept-charset="UTF-8" class="form-horizontal">
                    {{ csrf_field() }}
