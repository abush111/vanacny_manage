...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_DisasterSeverities-List')
                            ...
                            @foreach ($disasterSeverities as $disasterSeverity)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('setting_DisasterSeverities-Edit')
                                        ...
                                        @endpermission
                                        @permission('setting_DisasterSeverities-Delete')
    ...
    @permission('setting_DisasterSeverities-AddNew')
