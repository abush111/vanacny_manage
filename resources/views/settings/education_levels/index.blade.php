...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_EducationLevels-List')
                            ...
                            @foreach ($educationLevels as $educationLevel)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('setting_EducationLevels-Edit')
                                        ...
                                        @endpermission
                                        @permission('setting_EducationLevels-Delete')
    ...
    @permission('setting_EducationLevels-AddNew')
