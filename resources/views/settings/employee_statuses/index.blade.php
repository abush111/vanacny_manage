...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_EmployeeStatus-List')
                            ...
                            @foreach ($employeeStatuses as $employeeStatus)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('setting_EmployeeStatus-Edit')
                                        ...
                                        @endpermission
                                        @permission('setting_EmployeeStatus-Delete')
    ...
    @permission('setting_EmployeeStatus-AddNew')
