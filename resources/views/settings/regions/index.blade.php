...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_Regions-List')
                @if (count($regions) == 0)
                            ...
                            @foreach ($regions as $region)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @permission('setting_Regions-Edit')
                                            <a href="{{ route('regions.region.edit', $region->id) }}"
                                                class="btn btn-warning mr-4" title="Edit Region">
                                                <span class="fa fa-edit text-white" aria-hidden="true"></span>
                                            </a>
                                        @endpermission
                                        @permission('setting_Regions-Delete')
    ...
    @permission('setting_Regions-AddNew')
