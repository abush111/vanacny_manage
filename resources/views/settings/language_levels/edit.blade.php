...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a
            href="{{ route('language_levels.language_level.index') }}">{{ __('employee.Language Levels') }}</a></li>
...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            @permission('setting_LanguageLevels-Edit')
                <form method="POST" action="{{ route('language_levels.language_level.update', $languageLevel->id) }}"
                    id="edit_language_level_form" name="edit_language_level_form" accept-charset="UTF-8" class="form-horizontal">
                    {{ csrf_field() }}
