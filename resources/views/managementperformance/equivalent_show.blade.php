...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('competencylists.competencylist.equivalentperformance_form_store') }}" accept-charset="UTF-8"
         ...
         <input type="hidden" value="{{$employee_evaluated->id  }}"name="evaluatedid" >
            ...
            <h5 class="ml-2">1. የኮምፒተንሲ አፈጻጸም (40%)</h5>
            <hr>
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @foreach ($competencies as $competency)
                        ...
                        <tr>
                            ...
                            @endpermission --}}
                            @foreach ($list->equivalentvalue as $elist)


                            @if($elist->peersevaluator_id==Auth::user()->employee && $elist->CompetencyWeightCompetencylist_id==$list->id && $elist->Employee_id==$employee_evaluated->id && $elist->Yearsetting_id== $years->id)
                            <td><input type="text" value="{{ $elist->peersvalue }}"  name="empvalue[]">
