                  ...
                  @foreach ($competencies as $competency)
                        ...
                        <tr>
                            ...
                            @permission('employeemanagement-List')
                                ...
                                @foreach ($list->immediatevalue as $elist)


                                @if($elist->evaluator_id==Auth::user()->employee && $elist->CompetencyWeightCompetencylist_id==$list->id)
                                <td><input type="text" value="{{ $elist->immediateevalue }}"  name="empvalue[]">
