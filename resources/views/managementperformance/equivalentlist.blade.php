            ...
            {{-- @else --}}
                <table class="table table-striped ">
                    ...
                    <tbody>
                        ...
                        <td>{{$equivalentreportstos->reportsTo->en_name }} </td>
                        <td>{{ $equivalentreportstos->reportsTo->en_name }}  </td>
                        ...
                        <td>
                            ...
                            {{ csrf_field() }}
                                        ...
                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                            ...
                                            <a href="{{ route('competencylists.competencylist.equivalentperformance_form_create', ['employee' => $employee->organizationUnitse->reportsTo->org_chairman->employee,  'year' => $years->id] ) }}"
                                       ...
                                       {{-- 
                                          @if(count($evaluatedyear) > 0)
                                            ...
                                            @if($year->id ==  $evaluatedyears->Yearsetting_id)
                                            <a href="{{ route('competencylists.competencylist.equivalentperformance_form_show', ['employee' => $equivalentreportstos->org_chairman->employee,  'year' => $year->id] ) }}"
                                                class="btn btn-success" title="Add Performance">
                                                <span class="fa fa-eye text-white" aria-hidden="true"></span>
                                            </a>
                                            @else

                                            <a href="{{ route('competencylists.competencylist.equivalentperformance_form_create', ['employee' => $equivalentreportstos->org_chairman->employee,  'year' => $year->id] ) }}"
                                                class="btn btn-primary " title="Edit competency list">
                                                <span class="fa fa-plus text-white" aria-hidden="true"></span>
                                            </a>
                                            @endif
                                         ...
                                         @endforeach
                                         @else
                                         <a href="{{ route('competencylists.competencylist.equivalentperformance_form_create', ['employee' => $equivalentreportstos->org_chairman->employee,  'year' => $years->id] ) }}"
                                            class="btn btn-primary " title="Edit competency list">
                                            <span class="fa fa-plus text-white" aria-hidden="true"></span>
                                        </a>
                                        @endif --}}
                                        ...
                                        @if($equivalentreportstos->org_chairman->employee ==  $evaluatedyears->Employee_id)
                                        <a href="{{ route('competencylists.competencylist.equivalentperformance_form_show', ['employee' => $equivalentreportstos->org_chairman->employee,  'year' => $year->id] ) }}"
                                            class="btn btn-success" title="Add Performance">
                                            <span class="fa fa-eye text-white" aria-hidden="true"></span>
                                        </a>
