...
@section('breadcrumb')
    <li class="breadcrumb-item"><a
            href="{{ route('salary_heights.salary_height.index') }}">{{ __('employee.Salary
                    Height') }}</a></li>
...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header clearfix">
            <h3 class="card-title">{{ $salaryHeight->salaryScales->name }} Scale, Level {{ $salaryHeight->level }}
            </h3>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th colspan="{{ $salaryHeight->salaryScales['salary_steps'] }}" class="text-center">
                            {{ __('employee.Steps') }}
