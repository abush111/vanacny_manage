...
<div class="row">
    ...
    <div class="form-group col-md-4{{ $errors->has('status') ? 'has-error' : '' }}">
        <label for="status" class="col-md-12 control-label">{{ __('setting.IsAvailable') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
            <div class="checkbox">
                <label for="status_1">
...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('job_title_category') ? 'has-error' : '' }}">
        <label for="job_title_category" class="col-md-12 ">{{ __('setting.JobTitle') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
    ...
    <div class="form-group col-md-4 {{ $errors->has('job_type') ? 'has-error' : '' }}">
        <label for="job_type" class="col-md-12 control-label">{{ __('setting.JobType') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('position_id') ? 'has-error' : '' }}">
        <label for="position_id" class="col-md-12 control-label">{{ __('setting.PositionID ') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <select class="form-control" id="salary" name="salary" required="true">
                <option value="" style="display: none;"
                    ...
                    selected>
                    {{ __('setting.Selectsalary') }}</option>
