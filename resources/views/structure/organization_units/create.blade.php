...
<li class="breadcrumb-item"><a
        href="{{ route('organization_units.organization_unit.index') }}">{{(__('setting.OrganizationUnit'))}}</a>
</li>
...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('organization_units.organization_unit.store') }}" accept-charset="UTF-8"
            id="create_organization_unit_form" name="create_organization_unit_form" class="form-horizontal">
            {{ csrf_field() }}
...
<div class="jumbotron bg-white">
    ...
    <div class="text-center">
        <p class="lead">
            {{-- @permission('organization-AddNew') --}}
