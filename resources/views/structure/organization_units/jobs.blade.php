...
<li class="breadcrumb-item"><a
        href="{{ route('organization_units.organization_unit.index') }}">{{(__('setting.Organization Unit'))}}</a>
</li>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('job_positions.job_position.show', $job->id) }}" class="btn btn-primary"
                            title="Show Job Position">
