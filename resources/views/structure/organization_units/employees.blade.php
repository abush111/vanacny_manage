...
<li class="breadcrumb-item"><a
        href="{{ route('organization_units.organization_unit.index') }}">{{('setting.OrganizationUnit')}}</a>
</li>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{-- @permission('organization_units-Employes') --}}
                        <a href="{{ route('employees.employee.show', $employee->id) }}" class="btn btn-primary"
                            title="Show Employee">
                            {{(__('setting.view_details'))}}
                        </a>
                        {{-- @endpermission --}}
                    </td>
                </tr>
