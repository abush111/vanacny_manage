...
<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="name" type="text" id="name" value="{{ old('name', optional($biography)->name) }}" minlength="1" maxlength="255" placeholder="Enter name here...">
...
<div class="form-group {{ $errors->has('age') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="age" type="number" id="age" value="{{ old('age', optional($biography)->age) }}" placeholder="Enter age here...">
...
<div class="form-group {{ $errors->has('biography') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="biography" type="text" id="biography" value="{{ old('biography', optional($biography)->biography) }}" minlength="1" placeholder="Enter biography here...">
...
<div class="form-group {{ $errors->has('sport') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="sport" type="text" id="sport" value="{{ old('sport', optional($biography)->sport) }}" minlength="1" placeholder="Enter sport here...">
...
<div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="gender" type="text" id="gender" value="{{ old('gender', optional($biography)->gender) }}" minlength="1" placeholder="Enter gender here...">
...
<div class="form-group {{ $errors->has('colors') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="colors" type="text" id="colors" value="{{ old('colors', optional($biography)->colors) }}" minlength="1" placeholder="Enter colors here...">
...
<div class="form-group {{ $errors->has('range') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="range" type="text" id="range" value="{{ old('range', optional($biography)->range) }}" minlength="1" placeholder="Enter range here...">
...
<div class="form-group {{ $errors->has('month') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="month" type="text" id="month" value="{{ old('month', optional($biography)->month) }}" minlength="1" placeholder="Enter month here...">
