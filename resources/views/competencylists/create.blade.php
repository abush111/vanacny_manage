 ...
 @section('content')
     <div class="card card-primary">
         ...
         <div class="card-body">
            ...
            <form method="POST" action="{{ route('competencylists.competencylist.store') }}" accept-charset="UTF-8" id="create_competencylist_form" name="create_competencylist_form" class="form-horizontal">
                {{ csrf_field() }}
                @include ('competencylists.form', [
                     ...
                     <div class="form-group">
                         <div class="col-md-offset-2 col-md-12 text-center">
                             ...
                             <a href="{{ route('competencylists.competencylist.index') }}" class="btn btn-warning mr-5 text-white"
