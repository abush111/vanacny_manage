...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a
            href="{{ route('competency_weights.competency_weight.index') }}">{{ __('setting.Addcompetency_weight') }}</a></li>
...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('competency_weights.competency_weight.update', $competencyWeight->id) }}" id="edit_competency_weight_form" name="edit_competency_weight_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
                ...
                @include ('competency_weights.form', [
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-12 text-center">
                            ...
                            <a href="{{ route('competency_weights.competency_weight.index') }}" class="btn btn-warning mr-5"
