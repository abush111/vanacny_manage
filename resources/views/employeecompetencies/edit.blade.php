...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('employeecompetencies.employeecompetency.update', $employeecompetency->id) }}" id="edit_employeecompetency_form" name="edit_employeecompetency_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
