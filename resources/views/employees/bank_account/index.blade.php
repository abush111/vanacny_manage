...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($employeeBankAccount->file))
                                            <a href="{{ asset('uploads/bankaccount/' . $employeeBankAccount->file) }}"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                <h4 class="modal-title">
                                                                    {{ __('employee.Reject Bank Account') }}</h4>
    ...
    @endpermission
    @if (count($employeeBankAccounts) > 0)
        @permission('bankAccount-Print')
            <a href="{{ route('employee_bank_accounts.employee_bank_account.print', $employee) }}" class="btn btn-primary"
                title="Print Employee Bank Account" target="_blank">
