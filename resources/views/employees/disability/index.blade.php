...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($employeeDisability->medical_certificate))
                                            <a href="{{ asset('uploads/disability/' . $employeeDisability->medical_certificate) }}"
                                    ...
                                    <td>
                                        @if ($employeeDisability->status == 1)
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                <h4 class="modal-title">{{ __('employee.Reject Disability') }}
                                                                </h4>
                                            ...
                                            @endpermission
                                        @elseif($employeeDisability->status == 2)
                                            @permission('disabilities-Delete')
    ...
    @permission('disabilities-AddNew')
    ...
    @endpermission
    @if (count($employeeDisabilities) > 0)
        @permission('disabilities-Print')
            <a href="{{ route('employee_disabilities.employee_disability.print', $employee) }}" class="btn btn-primary"
                title="Print Employee Disability" target="_blank">
