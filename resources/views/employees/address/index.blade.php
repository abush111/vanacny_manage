...
@section('content')
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary">
                                                            <h4 class="modal-title">{{ __('employee.Reject Address') }}
                                                            </h4>
    ...
    @if (count($employeeAddresses) > 0)
        @permission('address_print')
            <a href="{{ route('employee_addresses.employee_address.print', $employee) }}" class="btn btn-primary"
                title="Print Employee Address" target="_blank">
