...
@endsection
@section('content')
@permission('employee-AddNew')
<div class="jumbotron">
    <h3 class="display-4 text-center text-success">{{(__('employee.Successfully Registered'))}}</h3>
    <p class="lead text-center">{{ $employee->en_name }} {{(__('employee.has been successfuly registered on the system.
        Choose an
...
<div class="card card-default">
    <div class="card-body m-5">
        ...
        <hr class="my-4">
        <ul>
            <li class="lead">{{(__('employee.If your organization has an Active Directory service then you can sync to
                it so that the
            ...
            <li class="lead">{{(__('Employee can add additional information such as certification and other details'))}}
            </li>
