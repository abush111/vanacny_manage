    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    @permission('disasterWitnesses-List')
                            ...
                            <tbody>
                                @foreach ($employeeDisasterWitnesses as $employeeDisasterWitness)
                                    <tr>
                                        ...
                                        <td>
                                            @permission('disasterWitnesses-Show')
                                        ...
                                        <td>
                                            @permission('disasterWitnesses-Edit')
                                            ...
                                            @endpermission
                                            @permission('disasterWitnesses-Delete')
            ...
            @permission('disasterWitnesses-AddNew')
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    @permission('disasterIndeminities-List')
                                ...
                                @foreach ($employeeDisasterIndeminities as $employeeDisasterIndeminity)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @permission('disasterIndeminities-Show')
                                        ...
                                        <td>
                                            @permission('disasterIndeminities-Edit')
                                            <button type="button" class="btn btn-warning mr-2" data-toggle="modal"
                                            ...
                                            @endpermission
                                            @permission('disasterIndeminities-Delete')
            ...
            @permission('disasterIndeminities-AddNew')
