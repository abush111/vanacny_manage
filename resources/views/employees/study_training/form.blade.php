...
<div class="row">
    <div class="form-group col-md-4 {{ $errors->has('field') ? 'has-error' : '' }}">
        <label for="field" class="col-md-4 control-label">{{ __('setting.EducationalFields') }} <span
                class="text-danger">*</span></label>
        <div class="col-md-12">
            ...
            <div class="input-group uploaded-file-group">
                <label class="input-group-btn">
                    <span class="btn btn-default">
                        {{ __('employee.Browse') }} <input type="file" name="attachment" required="true" id="attachment"
                            class="hidden">
                    </span>
                </label>
