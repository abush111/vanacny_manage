...
@section('content')
                        ...
                        <tbody>
                            @foreach ($employeeEducations as $employeeEducation)
                                <tr>
                                    ...
                                    <td>{{ $employeeEducation->gpa }} /
                                        {{ optional($employeeEducation->gpaScales)->name }}
                                    </td>
                                    <td>
    ...
    @endpermission
    @if (count($employeeEducations) > 0)
        @permission('educations-Print')
            <a href="{{ route('employee_educations.employee_education.print', $employee) }}" class="btn btn-primary"
                title="Print Employee Education" target="_blank">
