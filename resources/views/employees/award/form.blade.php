...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('organization') ? 'has-error' : '' }}">
        ...
        <div class="col-md-12">
            ...
            oninput="process(this)" value="{{ old('organization', optional($employeeAward)->organization) }}" minlength="1"
            ...
            <div class="input-group uploaded-file-group">
                <label class="input-group-btn">
                    <span class="btn btn-default">
                        {{(__('employee.Browse'))}} <input type="file" name="attachment" id="attachment" required="true" class="hidden">
                    </span>
                </label>
