            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ asset('uploads/misc/' . $employeeFile->attachment) }}" class="btn btn-primary mr-3"
                    ...
                    <td>
                        <form method="POST"
                            action="{!! route('employee_files.employee_file.destroy', ['employee' => $employeeFile->employees->id, 'employeeFile' => $employeeFile->id]) !!}"
...
@endpermission
@if (count($employeeFiles) > 0)
@permission('files-Print')
<a href="{{ route('employee_files.employee_file.print', $employee) }}" class="btn btn-primary"
    title="Print Employee File" target="_blank">
