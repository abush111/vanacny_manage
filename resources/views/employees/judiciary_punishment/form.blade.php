...
<div class="row">
    <div class="form-group col-md-6 {{ $errors->has('court_name') ? 'has-error' : '' }}">
        <label for="court_name" class="col-md-12 control-label">{{ __('employee.Court Name') }} <span
    ...
    <div class="form-group col-md-6 {{ $errors->has('punishment_type') ? 'has-error' : '' }}">
        ...
        <div class="col-md-12">
            <input class="form-control" name="punishment_type" type="text" id="punishment_type"
                ...
                oninput="process(this)"   minlength="1" required="true" placeholder="{{ __('employee.Enter punishment type here') }}">
        </div>
    </div>
</div>
