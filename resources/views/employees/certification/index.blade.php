            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST"
                            action="{!! route('employee_certifications.employee_certification.destroy', ['employee' => $employeeCertification->employees->id, 'employeeCertification' => $employeeCertification->id]) !!}"
                            accept-charset="UTF-8">
                            @method('DELETE')
                            {{ csrf_field() }}
                            <div class="btn-group btn-group-xs pull-right" role="group">
                                @permission('certifications-Show')
...
@permission('certifications-AddNew')
...
@endpermission
@if (count($employeeCertifications) > 0)
@permission('certifications-Print')
<a href="{{ route('employee_certifications.employee_certification.print', $employee) }}" class="btn btn-primary"
    title="Print Employee Certification" target="_blank">
