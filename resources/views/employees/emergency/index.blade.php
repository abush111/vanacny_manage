...
@section('content')
                        ...
                        <tbody>
                            @foreach ($employeeEmergencies as $employeeEmergency)
                                <tr>
                                    ...
                                    <td>
                                        @if ($employeeEmergency->status == 1)
                                            @permission('emergencies_approve-Reject')
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                <h4 class="modal-title">{{ __('employee.Reject Emergency') }}
                                                                </h4>
    ...
    @endpermission
    @if (count($employeeEmergencies) > 0)
        @permission('emergencies-Print')
            <a href="{{ route('employee_emergencies.employee_emergency.print', $employee) }}" class="btn btn-primary"
                title="Print Employee Emergency" target="_blank">
