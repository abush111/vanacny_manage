...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('phone_number') ? 'has-error' : '' }}">
        ...
        <div class="col-md-12">
            <input class="form-control" name="phone_number" type="tel" onkeypress="return /^[0-9]\d*$/i.test(event.key)" maxlength="13" minlength="10"
             id="phone_number" value="{{ old('phone_number', optional($employeeEmergency)->phone_number) }}"
...
<div class="row">
    ...
    <div class="form-group col-md-4 {{ $errors->has('other_phone') ? 'has-error' : '' }}">
        <label for="other_phone" class="col-md-12 control-label">{{(__('employee.Other Phone Number'))}}</label>
        <div class="col-md-12">
            <input class="form-control" name="other_phone" type="text" id="other_phone" onkeypress="return /^[0-9]\d*$/i.test(event.key)" maxlength="13" minlength="10"
