            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST"
                            action="{!! route('employee_experiences.employee_experience.destroy', ['employee' => $employeeExperience->employees->id, 'employeeExperience' => $employeeExperience->id]) !!}"
                            accept-charset="UTF-8">
                            @method('DELETE')
                            {{ csrf_field() }}
                            <div class="btn-group btn-group-xs pull-right" role="group">
                                @permission('experience-Show')
...
@endpermission
@if (count($employeeExperiences) > 0)
@permission('experience-Print')
<a href="{{ route('employee_experiences.employee_experience.print', $employee) }}" class="btn btn-primary"
    title="Print Employee Experience" target="_blank">
