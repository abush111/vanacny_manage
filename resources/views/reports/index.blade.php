...
@permission('setting_Reports_List')
        ...
        <table class="table table-striped ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{!! route('reports.report.destroy', $report->id) !!}"
                            accept-charset="UTF-8">
                            @method('DELETE')
                            {{ csrf_field() }}
                            <div class="btn-group btn-group-xs pull-right" role="group">
                                @permission('setting_Reports_Show')
                                <a href="{{ route('reports.report.show', $report->id) }}" class="btn btn-primary"
                                    title="Show Report">
